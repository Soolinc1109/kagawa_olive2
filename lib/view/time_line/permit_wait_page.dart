...
class WaitPermit extends StatefulWidget {
  final Account myInfo;
  const WaitPermit({Key? key, required this.myInfo}) : super(key: key);

  @override
  _WaitPermitState createState() => _WaitPermitState();
}

class _WaitPermitState extends State<WaitPermit> {
  var _city = '';
                  ...
                  Padding(
                    ...
                    child: StreamBuilder<QuerySnapshot>(
                        stream: FirebaseFirestore.instance
                            ...
                            .where('is_permit', isEqualTo: false)
                            .snapshots(),

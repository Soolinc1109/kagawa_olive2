...
class GenreLinePage extends StatefulWidget {
  final Category category;
  const GenreLinePage({Key? key, required this.category}) : super(key: key);

  @override
  _GenreLinePageState createState() => _GenreLinePageState();
}

class _GenreLinePageState extends State<GenreLinePage> {
  @override
                  ...
                  StreamBuilder<QuerySnapshot>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return FutureBuilder<List<Shop>?>(
                            future: ShopFirestore.getGenreShops(
                                shoplist, widget.category.id),
                            builder: (context, snapshot) {
                              print('============222=========');
                              if (snapshot.hasData) {

...
class VistUserPage extends StatefulWidget {
  final Shop shopInfo;
  const VistUserPage({Key? key, required this.shopInfo}) : super(key: key);

  @override
  _VistUserPageState createState() => _VistUserPageState();
}

class _VistUserPageState extends State<VistUserPage> {
  var _city = '';
                    ...
                    child: StreamBuilder<QuerySnapshot>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return FutureBuilder<List<Account>?>(
                              future:
                                  ShopFirestore.getVisitUsersFromIds(userList),
                              builder: (context, snapshot) {
